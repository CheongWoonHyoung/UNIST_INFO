...
import static com.example.owner.myunist_info.R.string.ECE_txt_0;
import static com.example.owner.myunist_info.R.string.ECHE_txt_0;
            ...
            case 0:
                ...
                switch(department_id){
                    case 1:
                        ...
                        main_backG1.setBackgroundResource(R.drawable.dhebg);
                    ...
                    case 2:
                       depart_name_ko.setText("에너지 및 화학공학부");
                        main_backG1.setBackgroundResource(R.drawable.echebg);
                        title.setText(ECHE_txt_0);
                    ...
                    case 4:
                        ...
                        main_backG1.setBackgroundResource(R.drawable.lsbg);
                    ...
                    case 7:
                        ...
                        main_backG1.setBackgroundResource(R.drawable.babg);
            ...
            case 1:
                ...
                switch(department_id){
                    case 1:
                        ...
                        main_backG2.setBackgroundResource(R.drawable.dhebg);
                        break;
                    case 2:
                        intro_track.setText("트랙 소개");
                    ...
                    case 4:
                        ...
                        main_backG2.setBackgroundResource(R.drawable.lsbg);
                        break;
                    case 5:
                        intro_track.setText("트랙 소개");
                        ...
                        main_backG2.setBackgroundResource(R.drawable.mnebg);
                        break;
                    case 6:
                        intro_track.setText("트랙 소개");
                        track_name.setText("신소재 과학");
                        content.setText("  신소재 과학 트랙의 학생들은 재료의 화학적, 열적, 기계적, 전기적인 물성 및 공정과 미세구조변화 등에 관해 학습하게 됩니다.   \n \n  금속, 세라믹, 반도체, 폴리머, 융복합재료 등 다양한 신소재들을 미세크기 영역에서부터 조대 크기 영역까지 이해할 수 있도록 교육을 제공하고 있습니다.   \n \n  이러한 최첨단 소재들은 자동차, 항공, 조선 등 기계재료산업, 반도체, 디스플레이 등 반도체 및 전자재료산업, 태양전지, 연료전지 등 에너지재료산업 등에 적용됩니다.   \n \n  신소재과학 트랙을 이수한 학생들은 향후 학습한 재료과학과 재료공학 지식에 바탕으로 하여 현대 재료과학 연구 및 첨단재료기술 분야에 크게 기여하는 중추적인 약할을 할 것으로 기대됩니다.   \n \n ");
                        main_backG2.setBackgroundResource(R.drawable.msebg);
                        break;
                    case 7:
                        intro_track.setText("트랙 소개");
                        track_name.setText("경영학");
                        content.setText("  매니지먼트 분야에서는 과학기술과 경영마인드를 접목하여 글로벌 경제시대를 선도해 나갈 수 있는 테크노 경영의 인재양성을 목표로 합니다.   \n \n  매니지먼트 분야에서는 기업의 경영자, 창업기업가, 경영컨설턴트 또는 자본시장의 이해관계자가 당면하는 경영의 다양한 이슈들에 대한 이해를 높이는 최상의 경영교육을 제공하고자 합니다.   \n \n  교과목은 조직행동론, 국제경영학, 마케팅, 재무회계, 관리회계, 재무관리, 경영 정책, 생산관리, 경제이론, 통계와 데이터분석 등을 포함합니다.   \n \n ");
                        main_backG2.setBackgroundResource(R.drawable.babg);
                        break;
                    default:
                        break;
            ...
            case 2:
                ...
                switch(department_id){
                    ...
                    case 4:
                        ...
                        main_backG3.setBackgroundResource(R.drawable.lsbg);
                        break;
                    case 5:
                        intro_track2.setText("트랙 소개");
                        ...
                        main_backG3.setBackgroundResource(R.drawable.mnebg);
                        break;
                    case 6:
                        intro_track2.setText("트랙 소개");
                        ...
                        main_backG3.setBackgroundResource(R.drawable.msebg);
                        break;
                    case 7:
                        intro_track2.setText("트랙 소개");
