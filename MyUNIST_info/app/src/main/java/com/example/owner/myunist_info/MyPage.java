...
public class MyPage  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mycontext,Attendance.class);
                startActivity(intent);
            }
        });
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mycontext,FAQ.class);
                startActivity(intent);
            }
        });
    ...
    private AlertDialog createDialog() {
        ...
        ab.setPositiveButton(R.string.call_dialog_confirm, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:052-217-4326"));
                startActivity(intent);
